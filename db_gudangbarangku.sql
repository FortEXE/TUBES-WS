...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2018 at 05:33 AM
...
INSERT INTO `barang` (`ID_BARANG`, `XID_KATEGORI`, `NAMA_BARANG`, `MERK_BARANG`, `TYPE_BARANG`, `HARGA_BARANG`, `STOK_BARANG`) VALUES
('BRG0001', 'K00001', 'INTEL CORE i7', 'Intel', 'CPU', 6000000, 5),
('BRG0002', 'K00002', 'NVIDIA GTX 1080', 'NVIDIA', 'GPU', 8000000, 10),
('BRG0003', 'K00003', 'Asus 8X External Slim DVD+/-RW Drive Optical Drives - SDRW-08D2S', 'ASUS', 'OPTICAL DRIVE', 300000, 3),
('BRG0004', 'K00004', 'Corsair Vengeance LPX', 'CORSAIR', 'RAM', 1000000, 10),
('BRG0005', 'K00005', 'ASUS ROG STRIX B250H', 'ASUS', 'MOTHERBOARD', 2000000, 20),
('BRG0006', 'K00006', 'COOLER MASTER MWE 450', 'COOLER MASTER', 'POWER SUPPLY', 400000, 13),
('BRG0007', 'K00007', 'SEAGATE FIRECUDA 2.5', 'SEAGATE', 'HDD', 1000000, 8);
...
ALTER TABLE `barang`
  ...
  ADD KEY `FK_ID_KATEGORI` (`XID_KATEGORI`,`TYPE_BARANG`) USING BTREE;
...
--
ALTER TABLE `detail_barang`
  MODIFY `ID_DETAIL_BARANG` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
...
--
ALTER TABLE `barang`
  ADD CONSTRAINT `FK_ID_KATEGORI` FOREIGN KEY (`XID_KATEGORI`,`TYPE_BARANG`) REFERENCES `kategori` (`ID_KATEGORI`, `NAMA_KATEGORI`);
...
ALTER TABLE barang DROP COLUMN type_barang;
ALTER TABLE barang ADD CONSTRAINT FK_ID_KATEGORI FOREIGN KEY (XID_KATEGORI) REFERENCES kategori (ID_KATEGORI);

INSERT INTO barang (ID_BARANG, XID_KATEGORI, NAMA_BARANG, MERK_BARANG, HARGA_BARANG, STOK_BARANG) VALUES
('BRG0008', 'K00001', 'AMD Ryzen 7 2700X', 'AMD', 5000000, 5),
('BRG0009', 'K00001', 'AMD Ryzen Threadripper 1950X', 'AMD', 20000000, 3),
('BRG0010', 'K00001', 'INTEL Core i9-7960X', 'Intel', 25000000, 4);

INSERT INTO detail_barang (ID_DETAIL_BARANG, ID_BARANG, NOMOR_SERI_DETAIL, STATUS_DETAIL, KETERANGAN_DETAIL) VALUES
(NULL, 'BRG0008', 'R7-001', 'READY', '-');

INSERT INTO detail_barang (ID_DETAIL_BARANG, ID_BARANG, NOMOR_SERI_DETAIL, STATUS_DETAIL, KETERANGAN_DETAIL) VALUES
(NULL, 'BRG0008', 'R7-002', 'RESERVED', '-'),
(NULL, 'BRG0008', 'R7-003', 'READY', '-'),
(NULL, 'BRG0008', 'R7-004', 'RESERVED', '-'),
(NULL, 'BRG0008', 'R7-005', 'READY', '-');

INSERT INTO detail_barang (ID_DETAIL_BARANG, ID_BARANG, NOMOR_SERI_DETAIL, STATUS_DETAIL, KETERANGAN_DETAIL) VALUES
(NULL, 'BRG0009', 'RT-001', 'READY', '-'),
(NULL, 'BRG0009', 'RT-002', 'READY', '-'),
(NULL, 'BRG0009', 'RT-003', 'RESERVED', '-');

INSERT INTO detail_barang (ID_DETAIL_BARANG, ID_BARANG, NOMOR_SERI_DETAIL, STATUS_DETAIL, KETERANGAN_DETAIL) VALUES
(NULL, 'BRG0010', 'i9-001', 'READY', '-'),
(NULL, 'BRG0010', 'i9-002', 'RESERVED', '-'),
(NULL, 'BRG0010', 'i9-003', 'RESERVED', '-'),
(NULL, 'BRG0010', 'i9-004', 'RESERVED', '-');


INSERT INTO barang (ID_BARANG, XID_KATEGORI, NAMA_BARANG, MERK_BARANG, HARGA_BARANG, STOK_BARANG) VALUES
('BRG0011', 'K00002', 'Radeon RX Vega 64', 'AMD', 25000000, 2),
('BRG0012', 'K00002', 'Radeon RX Vega 64 Liquid Cooled', 'AMD', 17000000, 3),
('BRG0013', 'K00002', 'NVIDIA Quadro GV100', 'NVIDIA', 150000000, 4);

INSERT INTO detail_barang (ID_DETAIL_BARANG, ID_BARANG, NOMOR_SERI_DETAIL, STATUS_DETAIL, KETERANGAN_DETAIL) VALUES
(NULL, 'BRG0011', 'RXV64-001', 'READY', '-'),
(NULL, 'BRG0011', 'RXV64-002', 'RESERVED', '-'),
(NULL, 'BRG0012', 'RXV64LC-001', 'READY', '-'),
(NULL, 'BRG0012', 'RXV64LC-002', 'READY', '-'),
(NULL, 'BRG0012', 'RXV64LC-003', 'RESERVED', '-'),
(NULL, 'BRG0013', 'GV100-001', 'RESERVED', '-'),
(NULL, 'BRG0013', 'GV100-002', 'RESERVED', '-'),
(NULL, 'BRG0013', 'GV100-003', 'READY', '-'),
(NULL, 'BRG0013', 'GV100-004', 'RESERVED', '-');

INSERT INTO barang (ID_BARANG, XID_KATEGORI, NAMA_BARANG, MERK_BARANG, HARGA_BARANG, STOK_BARANG) VALUES
('BRG0014', 'K00003', 'Lenovo Thinkpad USB Slim', 'Lenovo', 25000000, 2);

INSERT INTO detail_barang (ID_DETAIL_BARANG, ID_BARANG, NOMOR_SERI_DETAIL, STATUS_DETAIL, KETERANGAN_DETAIL) VALUES
(NULL, 'BRG0014', 'LTUSBS-001', 'READY', '-'),
(NULL, 'BRG0014', 'LTUSBS-002', 'READY', '-');

UPDATE barang SET nama_barang = 'Asus 8X External Slim' WHERE ID_BARANG = 'BRG0003';

INSERT INTO barang (ID_BARANG, XID_KATEGORI, NAMA_BARANG, MERK_BARANG, HARGA_BARANG, STOK_BARANG) VALUES
('BRG0015', 'K00004', 'VGEN 4GB DDR4 PC', 'VGen', 700000, 20),
('BRG0016', 'K00004', 'Kingstone 4GB DDR3 PC', 'Kingstone', 400000, 10),
('BRG0017', 'K00004', 'OCPC 8GB DDR3 PC', 'OCPC', 1400000, 15);

ALTER TABLE barang ADD COLUMN XID_PENGGUNA int(11) not null;

UPDATE barang SET XID_PENGGUNA = 1 WHERE XID_PENGGUNA = 0;
...
INSERT INTO detail_barang (ID_DETAIL_BARANG, ID_BARANG, NOMOR_SERI_DETAIL, STATUS_DETAIL, KETERANGAN_DETAIL) VALUES
(NULL, 'BRG0015', 'VGEN4D4-001', 'READY', '-'),
(NULL, 'BRG0015', 'VGEN4D4-002', 'READY', '-'),
(NULL, 'BRG0015', 'VGEN4D4-003', 'READY', '-'),
(NULL, 'BRG0015', 'VGEN4D4-004', 'READY', '-'),
(NULL, 'BRG0015', 'VGEN4D4-005', 'READY', '-'),
(NULL, 'BRG0015', 'VGEN4D4-006', 'READY', '-'),
(NULL, 'BRG0015', 'VGEN4D4-007', 'READY', '-'),
(NULL, 'BRG0015', 'VGEN4D4-008', 'READY', '-'),
(NULL, 'BRG0015', 'VGEN4D4-009', 'READY', '-'),
(NULL, 'BRG0015', 'VGEN4D4-010', 'RESERVED', '-'),
(NULL, 'BRG0015', 'VGEN4D4-011', 'RESERVED', '-'),
(NULL, 'BRG0015', 'VGEN4D4-012', 'READY', '-'),
(NULL, 'BRG0015', 'VGEN4D4-013', 'RESERVED', '-'),
(NULL, 'BRG0015', 'VGEN4D4-014', 'RESERVED', '-'),
(NULL, 'BRG0015', 'VGEN4D4-015', 'RESERVED', '-'),
(NULL, 'BRG0015', 'VGEN4D4-016', 'READY', '-'),
(NULL, 'BRG0015', 'VGEN4D4-017', 'READY', '-'),
(NULL, 'BRG0015', 'VGEN4D4-018', 'READY', '-'),
(NULL, 'BRG0015', 'VGEN4D4-019', 'READY', '-'),
(NULL, 'BRG0015', 'VGEN4D4-020', 'READY', '-'),

(NULL, 'BRG0016', 'KING4D3-001', 'READY', '-'),
(NULL, 'BRG0016', 'KING4D3-002', 'READY', '-'),
(NULL, 'BRG0016', 'KING4D3-003', 'DEFACED', '-'),
(NULL, 'BRG0016', 'KING4D3-004', 'READY', '-'),
(NULL, 'BRG0016', 'KING4D3-005', 'READY', '-'),
(NULL, 'BRG0016', 'KING4D3-006', 'READY', '-'),
(NULL, 'BRG0016', 'KING4D3-007', 'DEFACED', '-'),
(NULL, 'BRG0016', 'KING4D3-008', 'READY', '-'),
(NULL, 'BRG0016', 'KING4D3-009', 'RESERVED', '-'),
(NULL, 'BRG0016', 'KING4D3-010', 'READY', '-'),

(NULL, 'BRG0017', 'OCPC8D3-001', 'READY', '-'),
(NULL, 'BRG0017', 'OCPC8D3-002', 'READY', '-'),
(NULL, 'BRG0017', 'OCPC8D3-003', 'READY', '-'),
(NULL, 'BRG0017', 'OCPC8D3-004', 'READY', '-'),
(NULL, 'BRG0017', 'OCPC8D3-005', 'RESERVED', '-'),
(NULL, 'BRG0017', 'OCPC8D3-006', 'READY', '-'),
(NULL, 'BRG0017', 'OCPC8D3-007', 'READY', '-'),
(NULL, 'BRG0017', 'OCPC8D3-008', 'RESERVED', '-'),
(NULL, 'BRG0017', 'OCPC8D3-009', 'RESERVED', '-'),
(NULL, 'BRG0017', 'OCPC8D3-010', 'DEFACED', '-'),
(NULL, 'BRG0017', 'OCPC8D3-011', 'READY', '-'),
(NULL, 'BRG0017', 'OCPC8D3-012', 'READY', '-'),
(NULL, 'BRG0017', 'OCPC8D3-013', 'DEFACED', '-'),
(NULL, 'BRG0017', 'OCPC8D3-014', 'READY', '-'),
(NULL, 'BRG0017', 'OCPC8D3-015', 'READY', '-');
...
(NULL, 'BRG0018', 'MSIM3-001', 'READY', '-'),
(NULL, 'BRG0018', 'MSIM3-002', 'READY', '-'),
(NULL, 'BRG0018', 'MSIM3-003', 'READY', '-'),
(NULL, 'BRG0018', 'MSIM3-004', 'RESERVED', '-'),
(NULL, 'BRG0018', 'MSIM3-005', 'READY', '-'),

(NULL, 'BRG0019', 'ASSZ3-001', 'READY', '-'),
(NULL, 'BRG0019', 'ASSZ3-002', 'READY', '-'),
(NULL, 'BRG0019', 'ASSZ3-003', 'RESERVED', '-'),
(NULL, 'BRG0019', 'ASSZ3-004', 'READY', '-'),
(NULL, 'BRG0019', 'ASSZ3-005', 'READY', '-'),

(NULL, 'BRG0020', 'GYGAX-001', 'READY', '-'),
(NULL, 'BRG0020', 'GYGAX-002', 'READY', '-'),
(NULL, 'BRG0020', 'GYGAX-003', 'READY', '-'),
(NULL, 'BRG0020', 'GYGAX-004', 'READY', '-'),
(NULL, 'BRG0020', 'GYGAX-005', 'RESERVED', '-'),

(NULL, 'BRG0021', 'CORSRM-001', 'READY', '-'),
(NULL, 'BRG0021', 'CORSRM-002', 'RESERVED', '-'),
(NULL, 'BRG0021', 'CORSRM-003', 'READY', '-'),
(NULL, 'BRG0021', 'CORSRM-004', 'READY', '-'),
(NULL, 'BRG0021', 'CORSRM-005', 'READY', '-'),

(NULL, 'BRG0022', 'EVGSUP-001', 'READY', '-'),
(NULL, 'BRG0022', 'EVGSUP-002', 'RESERVED', '-'),
(NULL, 'BRG0022', 'EVGSUP-003', 'RESERVED', '-'),
(NULL, 'BRG0022', 'EVGSUP-004', 'READY', '-'),
(NULL, 'BRG0022', 'EVGSUP-005', 'READY', '-'),

(NULL, 'BRG0023', 'SEASNC-001', 'READY', '-'),
(NULL, 'BRG0023', 'SEASNC-002', 'READY', '-'),
(NULL, 'BRG0023', 'SEASNC-003', 'READY', '-'),
(NULL, 'BRG0023', 'SEASNC-004', 'READY', '-'),
(NULL, 'BRG0023', 'SEASNC-005', 'READY', '-'),

(NULL, 'BRG0024', 'HDD35I4-001', 'RESERVED', '-'),
(NULL, 'BRG0024', 'HDD35I4-002', 'READY', '-'),
(NULL, 'BRG0024', 'HDD35I4-003', 'RESERVED', '-'),
(NULL, 'BRG0024', 'HDD35I4-004', 'RESERVED', '-'),
(NULL, 'BRG0024', 'HDD35I4-005', 'RESERVED', '-'),
(NULL, 'BRG0024', 'HDD35I4-006', 'READY', '-'),
(NULL, 'BRG0024', 'HDD35I4-007', 'READY', '-'),

(NULL, 'BRG0025', 'SBC25I1-001', 'READY', '-'),
(NULL, 'BRG0025', 'SBC25I1-002', 'READY', '-'),
(NULL, 'BRG0025', 'SBC25I1-003', 'DEFACED', '-'),
(NULL, 'BRG0025', 'SBC25I1-004', 'READY', '-'),

(NULL, 'BRG0026', 'SFC25I2-001', 'READY', '-'),
(NULL, 'BRG0026', 'SFC25I2-002', 'READY', '-'),
(NULL, 'BRG0026', 'SFC25I2-003', 'READY', '-');

UPDATE barang SET MERK_BARANG = 'INTEL' WHERE MERK_BARANG = 'Intel';
UPDATE barang SET MERK_BARANG = 'LENOVO' WHERE MERK_BARANG = 'Lenovo';
UPDATE barang SET MERK_BARANG = 'VGEN' WHERE MERK_BARANG = 'VGen';
UPDATE barang SET MERK_BARANG = 'KINGSTONE' WHERE MERK_BARANG = 'Kingstone';
UPDATE barang SET MERK_BARANG = 'SEAGATE' WHERE MERK_BARANG = 'Seagate';
